...
class ImportDatasetRequest(object):
    ...
    def __init__(self, records=None, storage_type=None, search_type='flat', train_ind=False, grid_train=False, nbits=768, qbits=768, target_accuracy=100, metadata_of_records=None, md_unique=False, convert_to_dataset=False, num_of_boards=None, num_of_clusters=None, dataset_name=None):  # noqa: E501
