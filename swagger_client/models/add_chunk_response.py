...
class AddChunkResponse(object):
    ...
    def __init__(self, status=None):  # noqa: E501
        """AddChunkResponse - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this AddChunkResponse.  # noqa: E501


        :return: The status of this AddChunkResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this AddChunkResponse.


        :param status: The status of this AddChunkResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AddChunkResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddChunkResponse):
            return False
