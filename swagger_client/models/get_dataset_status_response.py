...
class GetDatasetStatusResponse(object):
    ...
    def __init__(self, dataset_status=None):  # noqa: E501
        """GetDatasetStatusResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def dataset_status(self):
        """Gets the dataset_status of this GetDatasetStatusResponse.  # noqa: E501


        :return: The dataset_status of this GetDatasetStatusResponse.  # noqa: E501
        :rtype: str
        """
        return self._dataset_status

    @dataset_status.setter
    def dataset_status(self, dataset_status):
        """Sets the dataset_status of this GetDatasetStatusResponse.


        :param dataset_status: The dataset_status of this GetDatasetStatusResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetDatasetStatusResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetDatasetStatusResponse):
            return False
